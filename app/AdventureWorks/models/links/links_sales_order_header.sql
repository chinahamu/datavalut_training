...
{%- set src_fk = ['sales_order_id', 'customer_id', 'sales_person_id', 'territory_id', 'bill_to_address_id', 'ship_to_address_id', 'ship_method_id', 'credit_card_id', 'credit_card_approval_code', 'currency_rate_id'] -%}
